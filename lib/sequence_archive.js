...
/**
 * Get a sequenceModel by id
 *
 * @method     getSequence
 * @param      {string}  id      An id for the sequenceModel
 * @return     {object|null}     Return the found sequenceModel or null
 */
SequenceArchive.prototype.getSequenceModel = function(id) {
 ...
 * @return     {object|null}     Return the found sequenceModel or null
 */
SequenceArchive.prototype.setSequenceModel = function(id, model) {

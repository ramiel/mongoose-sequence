...
Sequence.prototype._setHooks = function() {
  var setPreSaveHook = function(sequence) {
    var schema = sequence._schema;
    var isParallel = sequence._options.parallel_hooks;

    var hook = function(next, done) {
      if (!isParallel) {
        done = next;
      }
      var doc = this;

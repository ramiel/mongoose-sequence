 ...
 * @param      {string}    id              The sequence string
 * @param      {array}    referenceValue  An array of values for the reference fields
 * @param      {Function}  callback        Called with the sequence counter incremented value
 */

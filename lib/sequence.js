...
Sequence.prototype._setHooks = function() {
    ...
    this._schema.pre('findOneAndUpdate', function(next) {
        ...
        referenceValue = _this._getCounterReferenceField(this._update['$setOnInsert']);
...
>>>>>>> Added support for 'findOneAndUpdate' and 'update' with upsert
};
